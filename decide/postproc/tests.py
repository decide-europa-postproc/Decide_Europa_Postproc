...
class PostProcTestCase(APITestCase):
    ...
    def test_imperiali(self):
        ...
        expected_result = [
            { "option": "Option 3", "number": 3, "votes": 23, "seats": 4 },
            { "option": "Option 1", "number": 1, "votes": 15, "seats": 2 },
            { "option": "Option 4", "number": 4, "votes": 12, "seats": 2 },
            { "option": "Option 5", "number": 5, "votes": 7, "seats": 1 },
            { "option": "Option 6", "number": 6, "votes": 5, "seats": 1 },
            { "option": "Option 2", "number": 2, "votes": 1, "seats": 0 },
        ]
